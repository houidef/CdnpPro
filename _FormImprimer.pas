...
UImpressionGrilleBilan,UmpressionAppreciation,UImpressionGrilleVierge;
...
begin//0
 //0052588C
    ...
    case a of
      ...
      2://00525AE3
        lvar_20 := TImpressionAppreciation.Create(f374, Printer.Canvas,EnteteDePage{EDI} , BasDePage{lvar_14}, b{lvar_1},Nil ,sub_004BC228,f370);

      3://00525B1D        
        lvar_24 := TImpressionGrilleVierge.Create(f374, Printer.Canvas,EnteteDePage , BasDePage, 0,sub_004BAA88(2), sub_004BC01C, f370);
