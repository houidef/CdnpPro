...
type
  ...
  public
    ...
    f4F8:Integer;//f4F8
    f4FC:byte;//f4FC
    procedure sub_00539F78(var Msg:TMsg); Message $401;//00539F78
    procedure sub_0053A074(var Msg:TMsg); Message $402;//0053A074
    procedure sub_0053FA60(var Msg:TMsg); Message $403;//0053FA60
    procedure sub_0053F9FC(var Msg:TMsg); Message $404;//0053F9FC
    procedure sub_0053A0C0(var Msg:TMsg); Message $405;//0053A0C0
    procedure sub_0053A140(var Msg:TMsg); Message $406;//0053A140
    procedure sub_0053C9E4(var Msg:TMsg); Message $408;//0053C9E4
    procedure sub_0053CA38(var Msg:TMsg); Message $409;//0053CA38
    procedure sub_0053CAFC(var Msg:TMsg); Message $40A;//0053CAFC
    procedure sub_0053CB34(var Msg:TMsg); Message $40B;//0053CB34
    procedure sub_0053CD90(var Msg:TMsg); Message $40D;//0053CD90
    procedure sub_0053D148(var Msg:TMsg); Message $40E;//0053D148
    procedure sub_0053D6F4(var Msg:TMsg); Message $40F;//0053D6F4
    procedure sub_0053E410(var Msg:TMsg); Message $412;//0053E410
    procedure sub_0053E44C(var Msg:TMsg); Message $413;//0053E44C
    procedure sub_0053F7DC(var Msg:TMsg); Message $415;//0053F7DC
    constructor Create(AOwner: TComponent;Handle : HWND; Logo:TImage; FileName:String);//00539894
	procedure sub_00539DA4(var Value:String);//00539DA4
	procedure sub_0053F8FC(var a:string);//0053F8FC
    procedure sub_0053DDF4(var Y:String);//0053DDF4
    procedure sub_0053DE0C(var Y:String);//0053DE0C
	procedure sub_00539DFC(b:TObject);
	procedure sub_0053F190(a:TObject);
	procedure sub_00539EF4(a:TObject);
  end;
...
//00539DA4
procedure TFeuilleClasse.sub_00539DA4(var Value:String);
begin//0
    //00539DBD
...
begin//0
  //0053A140
    ...
    FichierCdn.sub_004BE8FC(buf);
    FichierCdn.sub_004BE974(buf0);// eq FichierCdn.FileName
    Caption := buf + ' - ' + ExtractFileName(buf0);
    ...
    begin//2
      ...
      begin//3
        ...
        begin//4
          ...
          TabSet1.TabIndex := 0;
          SendMessageA(GrilleNotesCarnetDeNotes.Handle, $403, f4FC, 0);
          SendMessageA(GrilleMoyennesCarnetDeNotes.Handle, $408, f4FC, 0);
          SendMessageA(GrilleBilanCarnetDeNotes.Handle, $403, TabControlGrillesBilan.TabIndex + 1, 0);
          SendMessageA(Handle, $40E, 0, 0);
          TabControlGrillesNotes.TabIndex := f4FC - 1;
		  ESI := FichierCdn.sub_004BEAD0(f4FC) - 1;
...
begin//0
  //0053B6E4
    ...
    begin//0053B780
        ...
        begin//4
          //0053B88A  
          FichierCdn.sub_004C8DF8(lvar_8.indexof(FormCreerListeEleves.f318[I - 1]) + 1 , FormCreerListeEleves.f320[lvar_8.indexof(FormCreerListeEleves.f318[I - 1])] = 'R');
        end;//4
      FichierCdn.sub_004C63C8;
...
begin//0
  //0053C1EC
    ...
    begin//2
      ...
      begin//3
        //0053C357
        FichierCdn.sub_004C1954(FormListeEleves.ListeEleves.ItemIndex + 1, FormModifierEleve.EditNomPrenom_FormModifier.Text,FormModifierEleve.CheckBoxRedoublant_FormModifier.Checked, FormModifierEleve.EditDateDeNaissance_FormModifier.Text);
        SendMessageA(GrilleNotesCarnetDeNotes.Handle, $403, f4FC, 0);
        SendMessageA(GrilleMoyennesCarnetDeNotes.Handle, $408, f4FC, 0);
        SendMessageA(GrilleElevesCarnetDeNotes.Handle, $404, 0, 0);
        SendMessageA(GrilleElevesGrapheCarnetDeNotes.Handle, $404, 0, 0);
    ...
    begin//2
	  ...
	  begin
		...
		begin
		  ...
		  sub_00539DA4(FileName);
		  pTo := PChar(sub_00497908[tag] + ':\' + ExtractFileName(FileName) + #0);
		  fFlags := $40{64};
...
begin//0
  //0053DA54
    ...
    sub_00539DA4(buf);
    recPointer.lpszPathName := PChar(buf);
	recPointer.lpszFileName := 0;
	recPointer.lpFileType := 0;
    sub_00539DA4(FileName);
	lpMessage.lpszSubject  := PChar('Envoi du fichier Carnet de Notes : ' + ExtractFileName(FileName)); //30
...
//0053DDF4
procedure TFeuilleClasse.sub_0053DDF4(var Y:String);
begin//0
  //0053DDF4
...
begin//0
  //0053E44C
    ...
    begin//0053E4AB
      ...
      Chart1.Legend.Visible := sub_004BBAF8;
      ...
      Chart1.Gradient.Visible := sub_004BBA80;
      Chart1.Gradient.StartColor :=sub_004BBB78;
      Chart1.Gradient.EndColor := sub_004BBBA8;
      Chart1.LeftWall.Color := sub_004BA108;
      Chart1.BottomWall.Color := sub_004BBD70;
    ...
    begin//0053E71C
      ...
      try
        ...
        begin//4
          ...
          lvar_28 := lvar_158 / StrToFloat(buf);
          FichierCdn.sub_004BED04(lvar_10, buf, I);
          Chart1.Series[1].AddXY(I, lvar_28, buf, sub_004BBCE4);
        ...
        begin//4
          ...
          lvar_28 := lvar_158 / StrToFloat(buf);
          FichierCdn.sub_004BED04( lvar_10, buf, I);
          Chart1.Series[2].AddXY(I, lvar_28, buf, sub_004BBCB4);
...
begin//0
  //0053FFBC
    ...
    if (sub_00498A40 = false) then//00540530
		Application.MessageBox('Impossible d''importer une série de notes. Le nombre de séries de notes est limité à 3 pour la version non enregistrée.','Carnet de Notes version Personnelle' , $40{64})
	else
		Application.MessageBox(PChar('Impossible d''importer une série de notes. Le nombre de séries de notes est limité à ' + IntToStr(gvar_00617903) + '.'),'Carnet de Notes version Personnelle' , $40{64});
	//005405AA
...
begin//0
  //0054155C
    ...
    begin//2
      ...
      if (sub_004B9410) then
      begin//00541661  
        sub_004B94D8(MainMenuPrincipal, 0, Self,  Ouvrir1Click); //006159A0A1
        SendMessageA(f4D8, $410, 0, 0);
      end;//3
    end;//2
...
procedure TFeuilleClasse.sub_00539DFC(b:TObject);
begin//0
  //00539DFC
  if (b is TMenuItem) then
  begin//1
    //00539E17
    TabSet1.TabIndex := 0;
    Notebook1.PageIndex := TabSet1.TabIndex;
    TabControlGrillesNotes.TabIndex :=  TMenuItem(b).MenuIndex;
    f4FC := TabControlGrillesNotes.TabIndex + 1;//EAX
    SendMessageA(GrilleNotesCarnetDeNotes.Handle, $403, f4FC, 0);
    SendMessageA(GrilleElevesCarnetDeNotes.Handle, $403, f4FC, 0);
    SendMessageA(GrilleMoyennesCarnetDeNotes.Handle, $408, f4FC, 0);
    SendMessageA(Handle, $40E, 0, 0);
  end;//1
end;//0
procedure TFeuilleClasse.sub_0053F190(a:TObject);
begin//0
  //0053F190
  if (a is TMenuItem) then
  begin//1
    //0053F1A7
    TabSet1.TabIndex := 2;
    Notebook1.PageIndex := TabSet1.TabIndex;
    TabControlGraphes.TabIndex := TMenuItem(a).MenuIndex;
    SendMessageA(GrilleElevesGrapheCarnetDeNotes.Handle, $403,TabControlGraphes.TabIndex + 1 , 0);
  end;//1
end;//0

procedure TFeuilleClasse.sub_00539EF4(a:TObject);
begin//0
  //00539EF4
  if (a is TMenuItem) then
  begin//1
    ...
    TabSet1.TabIndex := 1;
    Notebook1.PageIndex := TabSet1.TabIndex;
    TabControlGrillesBilan.TabIndex := TMenuItem(a).MenuIndex;
    SendMessageA(GrilleBilanCarnetDeNotes.Handle, $403, TabControlGrillesBilan.TabIndex + 1, 0);
  end;//1
end;//0
