	  ...
	  begin
        ...
        begin//004D1D0D
          ...
          begin//004D1D1A
            ...
            FichierCdn.sub_004C5404(f2D8, ARow, Buf); //Determiner la Note la plus basse de la période
            FormHint.Label2.Caption := 'Note la plus basse de la période : ' + Buf;
            FichierCdn.sub_004C56C0( f2D8, ARow, Buf);// Determiner la Note la plus haute de la période
