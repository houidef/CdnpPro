...
begin//0
  //0060BD00
    ...
    if (sub_00498A40 = false) then //0060BE92
...
begin
  ...
  for I:= 1 to MDIChildCount do begin
      //0060C03F
      sub_004B94D8(TFeuilleClasse(MDIChildren[I-1]).MainMenuPrincipal, 0, Self,Ouvrir1Click);
