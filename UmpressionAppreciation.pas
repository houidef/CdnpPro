...
uses
  ...
  Unit173, _FormProgression,Unit111,Forms, Dialogs,_Unit112;
type
...
begin//0
  ...
  J := 0;
  f50[0] := 1;
  L := sub_0052199C Div (f24 - sub_00519AF8(sub_004BD238, sub_004BDA58) - sub_00522F88);
...
begin//0
  //00521834
    //00521864
    Val := 0;
    if (f3C.sub_004C8AE8 > 0) then
    begin//2
      for I := 1 to f3C.sub_004C8AE8 do//00521887
      begin//3
        //0052188C
        f3C.sub_004C8AF4(I, buf);
...
begin//0
  //0052199C
    //005219BC
    Val := 0;
      for I := 1 to f3C.sub_004BEA58  do//005219DC
      begin//3
        //005219E6
        for J := 1 to f3C.sub_004C8AE8 do
        begin//4
          //005219FD
          f3C.sub_004C2C00(f2C, I, J, buf);
          if (f40.TextWidth(buf) > Val) then 
			Val := f40.TextWidth(buf);
        end;//4
      end;//3
...
begin//0
  //00521C10
    ...
    lvar_24 := sub_00519AF8(sub_004BD238, sub_004BDA58);
    ...
    StrList := TStringList.Create;
      for lvar_20 := 1 to f3C.sub_004BEA58  do//00521D87
      begin//3
        //00521D91
        f3C.sub_004C2D10(f2C, lvar_20, sub_004B9E10, buf);
        StrList.Add(buf);
      end;//3
    sub_004BDCFC(StrList, lvar_5C);
    sub_004BDB3C(StrList, lvar_60);
    sub_004BDEBC(StrList, lvar_64);
    StrList.Destroy;
    ...
    begin//2
      ...
      begin//3
        ...
        begin//4
          ...
          lvar_8C.Bottom := lvar_8C.Top + lvar_18;//EAX
          if ((f3C.sub_004C8E50(lvar_20)) and (sub_004BDA58))then//0052229E
          begin//5
              //005222A7
              f3C.sub_004BEA64(lvar_20, buf);
              lvar_68 := buf + ' (R)';
          end//5
          else
          begin//5
            //005222EF
            f3C.sub_004BEA64(lvar_20, lvar_68);
          end;//5
          if (sub_004BD238 ) then
          begin//5
            //0052232C
            f3C.sub_004C8BB8(lvar_20, lvar_50);
        ...
        begin//4
          ...
          lvar_8C.Bottom := lvar_8C.Top + lvar_18;//EAX
          if ((f3C.sub_004C8E50(lvar_20) ) and (sub_004BDA58 )) then//0052246E
          begin//5
              //00522477
              f3C.sub_004BEA64(lvar_20, buf);
              lvar_68 := buf + ' (R)';
        ...
        begin//4
          ...
          case lvar_1C of
            ...
            begin//6
              //0052269B
              f3C.sub_004C2D10(f2C, lvar_20, sub_004B9E10, lvar_54);
            end;//6
            2:
            begin//6
              //005226E6
        ...
        lvar_1C := 1;
          ...
          begin//5
            ...
            lvar_8C.Right := lvar_8C.Left + lvar_14;//EAX
            lvar_8C.Bottom := lvar_8C.Top + lvar_18;//EAX
            f3C.sub_004C2C00(f2C, lvar_20, f50[a - 1], buf);
            lvar_54 := ' ' + buf + ' ';
            DrawTextA(f40.Handle, PChar(lvar_54), Length(lvar_54), lvar_8C, 4);
          end;//5
      ...
      for lvar_1C := 0 to f3C.sub_004C8AE8 + lvar_C + 4 - 1 do//00522AFF
      begin//3
        //00522B0A
        if (lvar_1C = 0) then
        begin//4
...
begin//0
  //00522F04
  result := sub_0052199C * (f50[a] - f50[a - 1]) + sub_00519AF8(sub_004BD238, sub_004BDA58) + sub_00522F88;//EDI
end;//0
