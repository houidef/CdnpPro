...
uses
  ...
  Unit173,_FormProgression,Dialogs,Forms,Unit111;
...
begin//0
  //0052309C
    ...
    lvar_1C := sub_00519AF8(sub_004BD278, sub_004BDA8C);
    lvar_C := f3C.sub_004BEA58 ;
    ...
    begin//2
      ...
      begin//3
        ...
        begin//4
          ...
          lvar_88.Bottom := lvar_88.Top + ESI;
          if ((f3C.sub_004C8E50(lvar_18)) and sub_004BDA8C) then//005234A3
          begin//5
              //005234AC
              f3C.sub_004BEA64(lvar_18, lvar_1A0);
              lvar_54 := lvar_1A0 + ' (R)';
          end//5
          else
          begin//5
            //005234F0
            f3C.sub_004BEA64(lvar_18, lvar_54);
          end;//5
          if (sub_004BD278) then
          begin//5
            //00523529
            f3C.sub_004C8BB8(lvar_18, lvar_1A0);
        ...
        begin//4
          ...
          lvar_88.Bottom := lvar_88.Top + ESI;//EAX
          if ((f3C.sub_004C8E50(lvar_18)) and sub_004BDA8C) then//0052365A
          begin//5
              //00523663
              f3C.sub_004BEA64(lvar_18, lvar_1A0);
              lvar_54 := lvar_1A0 + '(R)';
    ...
    begin//2
      //005238C4
        ...
        begin//4
          ...
          lvar_88.Left := lvar_28;//lvar_28
          lvar_88.Top := ESI * (f3C.sub_004BEA58 + lvar_3C + 1) + lvar_2C + 20;//EAX
          lvar_88.Right := lvar_88.Left + lvar_1C;//EAX
          lvar_88.Bottom := lvar_88.Top + ESI;//EAX
    ...
    begin//2
      ...
      begin//3
        ...
        begin//4
          //00523BD2
          f40.MoveTo(lvar_28, (f3C.sub_004BEA58 + 1 + lvar_14) * ESI + lvar_2C + 20);
          f40.LineTo(lvar_28 + lvar_20, (f3C.sub_004BEA58 + 1 + lvar_14) * ESI + lvar_2C + 20);
        end;//4
      end;//3
    end;//2
...
begin//0
  //005243EC
  K:=(f24 - sub_00519AF8(sub_004BD278, sub_004BDA8C)) Div sub_005243D4;
...
begin//0
  //005245A0
  result := sub_005243D4 * (f50[a] - f50[a - 1]) + sub_00519AF8(sub_004BD278, sub_004BDA8C);
end;//0
