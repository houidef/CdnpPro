...
implementation
	uses UEnregistrement,_FormAide,Unit111;
{$R *.DFM}
  ...
  //0055152C
    ...
    case Notebook1.PageIndex of
      ...
      begin//3
        ...
        CheckListBox1.Items := f368[0].sub_004BEA4C;
        SpeedButtonSuivant.Enabled := False;
      ...
      begin//3
        ...
        f368[0].sub_004BE8FC(buf);
        Edit1.Text := buf;
        f368[0].sub_004BE914(buf);
        Edit2.Text := buf;
        Edit3.Text := 'Toutes les matières';
        f368[0].sub_004BE944(buf);
        Edit4.Text := buf;
...
begin//0
  //00551F70
    ...
    f368[0].sub_004BE988(buf);
    lvar_C.sub_004C4CC8(buf);
    lvar_1C := TStringList.Create;
      
      for I := 1 to f368[0].sub_004BE9E0()  do//00552014
      begin//3
        //0055201C
        f368[0].sub_004BE9EC(I, buf);
        lvar_1C.Add(buf);
      end;//3
    lvar_C.sub_004C4CBC(lvar_1C);
    lvar_1C.Destroy;
    lvar_C.sub_004C3920(ComboBoxUtilisateurs.Items[ComboBoxUtilisateurs.ItemIndex]);
    lvar_C.sub_004BEFD0(Edit1.Text);
    lvar_C.sub_004BF004(Edit2.Text);
    lvar_C.sub_004BF038(Edit3.Text);
    lvar_C.sub_004BF06C(Edit4.Text);
    lvar_C.sub_004BF0A0(Edit5.Text);
    lvar_C.sub_004BF64C(f368[0].sub_004BEAC4);
    lvar_C.sub_004BF0D4;
      for I := 1 to f368[0].sub_004BE9E0 do//00552240
      begin//3
        //00552248
        lvar_10 := 1;
        ...
        begin//4
          //005522A2
          f368[J].sub_004BE92C(lvar_12C);
          f368[J].sub_004BE974(lvar_A50);
          ...
          case RadioGroupDonneesARetenir.ItemIndex of
            ...
            begin//6
              ...
              lvar_C.sub_004BF7F0(I, lvar_D64, lvar_A2C, '', 'oui', lvar_B54, lvar_C5C, '', false);
              if (f368[0].sub_004BEA58 <= 0) then Continue;
              for K := 1 to f368[0].sub_004BEA58  do
              begin//7
                //00552479
                f368[J].sub_004C2D10(I, K, f368[J].sub_004C4D44, lvar_A2C);
                lvar_C.sub_004C1074(I, J + 1, K, lvar_A2C);
              end;//7
            end;//6
            1:
            begin//6
              //00552530
              lvar_1C := f368[J].sub_004C3134(I);
                for lvar_18 := 1 to lvar_1C.count do //00552570
                begin//8
                  //0055257A
                  lvar_C.sub_004BF7F0(I, 'Moy. ' + lvar_1C[lvar_18 - 1] + ' - ' + lvar_12C{lvar_D68}, IntToStr(sub_004B9E48), '', 'oui', DateToStr(Date), 'Extrait de ' + lvar_A4C, 'Moyenne type de notes', false);
                  ...
                  begin//9
                    ...
                    begin//10
                      //005526FD
                      f368[J].sub_004C2E60(lvar_1C[lvar_18 - 1], I,K,lvar_A2C );
                      lvar_C.sub_004C1074(I,lvar_10, K,lvar_A2C);
                    end;//10
                  end;//9
                  lvar_10 := lvar_10 + 1;
                end;//8
            ...
            begin//6
              //005527E2
              for lvar_18 := 1 to f368[J].sub_004BEAD0(I) do
              begin//7
                //00552826
                f368[J].sub_004BED2C(I,lvar_18 , lvar_32C);
                f368[J].sub_004BED7C(I,lvar_18 , lvar_42C);
                f368[J].sub_004BEDCC(I,lvar_18 , lvar_52C);
                f368[J].sub_004BEE1C(I, lvar_18, lvar_62C);
                f368[J].sub_004BED04(I, lvar_A2C, lvar_18);
                lvar_72C := lvar_A2C + ' - ' + lvar_12C;
                f368[J].sub_004BEEBC(I, lvar_18, lvar_92C);
                f368[J].sub_004BEE6C(I,lvar_18 , lvar_82C);
                f368[J].sub_004BEF0C(I, lvar_18, lvar_A2C);
				lvar_C.sub_004BF7F0(I, lvar_72C, lvar_32C, lvar_42C, lvar_52C, lvar_62C, lvar_82C, lvar_92C, lvar_A2C = 'Oral');
                  for K := 1 to f368[0].sub_004BEA58 do//00552B29
                  begin//9
                    //00552B31
                    f368[J].sub_004BEF5C(I, lvar_18, K, lvar_A2C);
                    lvar_C.sub_004C1074(I, lvar_10,K , lvar_A2C);
                  end;//9
                lvar_10 := lvar_10 + 1;
              end;//7
    ...
    begin//2
      //00552C08
	  lvar_C.sub_004C01F8(SaveDialog1.FileName, false, '', 0);
