...
uses
Forms, Windows,  SysUtils, Classes,UImpression,UFichierCdn,Graphics,Unit173,UInclureImpression,
Printers,_FormProgression,Unit111,_Unit112,dialogs;
...
begin//0
  ...
  SetLength(f50, 1);
  f50[0] := 1;
  K := (f24 - sub_00519AF8( sub_004BD1FC, sub_004BDA2C))  Div sub_0051D370;
  if (K = 0) then //0051CE0D
    result := 0
  else
  begin//1
    //0051CE14
    if (sub_004BC1BC ) then //0051CE1D
      NbrCololTotal := 2
    else //0051CE26
      NbrCololTotal := 1;
    if (sub_004BC188 ) then //0051CE36
      NbrCol := 2
    else //0051CE40
      NbrCol := 0;
    if (f58 = false) then
    begin//2
      //0051CE53
      if (sub_004BB35C) then
      begin//3
        //0051CE5C
        NbrCol := NbrCol + f3C.sub_004C3134(f2C).count;
      end;//3
    ...
    begin//2
      //0051CE94
      if (sub_004BB35C = false) then //0051CE9D
        NbrCololTotal:= NbrCololTotal + f3C.sub_004BE9E0()
      else
      begin//3
        //0051CEB7
        NbrCol:= f3C.sub_004C3134(f2C).count + NbrCol + f3C.sub_004BE9E0();
      end;//3
      NbrCololTotal := NbrCololTotal + NbrCol;
    end;//2
	I := 0;
    ...
    begin//2
      ...
      begin//3
        //0051CFAD
        f54 := f3C.sub_004C3134(f2C).count + 2;//EAX
      end//3
      else
      begin//3
        //0051CFD8
    ...
    begin//2
      //0051CFEF
      if (sub_004BB35C = false) then
      begin//3
        //0051CFF8
        f54 :=  f3C.sub_004BE9E0() + 2;
      end//3
      else
      begin//3
        //0051D013
        f54 := f3C.sub_004C3134(f2C).count + f3C.sub_004BE9E0() + 2;
      end;//3
      f54 := f54 + NbrCol;
    end;//2
    if (sub_004BC1BC = false) then
    begin//2
      //0051D06A
      f54 := f54 - 1;
    end;//2
...
begin//0
  //0051D080
    ...
    begin//2
      //0051D136
        for I := 0 to f3C.sub_004BE9E0() - 1 do//0051D150
        begin//4
          //0051D153
          if (f3C.sub_004BEAD0(I + 1) > 0) then
          begin		  
				f3C.sub_004BE988(buf);
			  if (f40.TextWidth(buf) > K) then 
				K := f40.TextWidth(buf);
		  end;
        end;//4
    end;//2
    if (sub_004BC1BC ) then
    begin//2
      //0051D1C3
      if (sub_004BB3F0 = 0) then //0051D1CC
    ...
    buf := ' Moyennes bulletin sur ' + IntToStr(sub_004B9E48);
    if (K < f40.TextWidth(buf)) then
    begin//2
      //0051D23F
      K := f40.TextWidth(buf);
    ...
    begin//2
      //0051D258
      buf := ' Moyennes annuelles sur ' + IntToStr(sub_004B9E48);
      if (K < f40.TextWidth(buf)) then
      begin//3
        //0051D28D
        K := f40.TextWidth(buf);
...
begin//0
  //0051D370
    ...
    begin//2
      //0051D39E
      lvar_C := f3C.sub_004C5078(f2C, sub_004BB3F0, sub_004B9E10, sub_004BC298, sub_004BC30C);
...
begin//0
  //0051D5B0
    ...
    lvar_24 := sub_00519AF8(sub_004BD1FC, sub_004BDA2C);
    ...
    begin//3
        ...
        begin//4
          ...
          if (sub_004BC1BC) then //0051D885
            K := f54 - 1
          else //0051D897
            K := f54;
          if (sub_004BC188) then
          begin//5
            //0051D8A6
            if (K - 1 = lvar_28) then
            begin//6
          ...
          begin//5
            //0051D8EB
            lvar_60 := 'Moyennes bulletin sur ' + IntToStr(sub_004B9E48);
          end;//5
        end//4
        else
        begin//4
          ...
          begin//5
            //0051D941
              ...
              lvar_E4 := f3C.sub_004BE9E0() + lvar_58;
              //EAX := lvar_58 + 1;//EAX
                if (lvar_28 <lvar_E4) then//0051D9DD
                begin//8
                  //0051D9E6
                  lvar_60 := f3C.sub_004BEA4C[lvar_28 - 1 - lvar_58];
                end;//8
          end//5
          else
          begin//5
            //0051DA0E
            lvar_E4 := f3C.sub_004BE9E0();
            if (lvar_28 <= 255) then
            begin//6
              //0051DA3F
              ...
              begin//7
                //0051DA48
                lvar_60 := f3C.sub_004BEA4C[lvar_28 - 1];
              end;//7
            end;//6
          end;//5
          if (sub_004BC188 ) then
          ...
          begin//5
            //0051DAAE
            lvar_60 := 'Moyennes annuelles sur ' + IntToStr(sub_004B9E48);
          end;//5
        end;//4
        if (sub_004BC1BC) then
        begin//4
	...
	// fin boucle  !
    lvar_74 := f3C.sub_004C5078(f2C, sub_004BB3F0, sub_004B9E10, sub_004BC298, sub_004BC30C);
    lvar_54 := f3C.sub_004BEA58;
    if (f34) then //0051DC0C
      ...
      begin//3
        ...
        begin//4
          ...
          R.Bottom := R.Top + lvar_18;//EAX
          if ((f3C.sub_004C8E50(lvar_20)) and sub_004BDA2C) then //0051DDE6
          begin//5
              //0051DDEF
              f3C.sub_004BEA64(lvar_20, lvar_200);
              lvar_6C := lvar_200 + ' (R)';
          end//5
          else
          begin//5
            //0051DE36
            f3C.sub_004BEA64(lvar_20, lvar_6C);
          end;//5
          if (sub_004BD1FC) then
          begin//5
            //0051DE72
            f3C.sub_004C8BB8(lvar_20, lvar_200);
        ...
        begin//4
          ...
          R.Bottom := R.Top + lvar_18;//EAX
          if ((f3C.sub_004C8E50(lvar_20)) and sub_004BDA2C) then//0051DFB4
          begin//5
              //0051DFBD
              f3C.sub_004BEA64(lvar_20, lvar_200);
              lvar_6C := lvar_200 + ' (R)';
        ...
        lvar_3C := 1;
          ...
          begin//5
            ...
            begin//6
              ...
              begin//7
                ...
                begin//8
                  ...
                  begin//9
                    //0051E240
                    f3C.sub_004C2E60(lvar_70[lvar_28 - 1], f2C,lvar_20, lvar_200);
                    f3C.sub_004C2410(lvar_200, sub_004B9E10, lvar_60);
                  end;//9
                end;//8
              end;//7
              if (sub_004BC188 ) then
              begin//7
                ...
                begin//8
                  //0051E312
                  f3C.sub_004C8F6C(f2C, lvar_20, sub_004B9E10, lvar_60);
                end;//8
                K := K - 2;//ESI
                if (K = lvar_28) then
                begin//8
                  //0051E366
                  f3C.sub_004C9280(f2C, lvar_20, sub_004B9E10, lvar_60);
                end;//8
              end;//7
              if (sub_004BC1BC ) then
              begin//7
                ...
                begin//8
                  //0051E3CD
                  f3C.sub_004C2D10(f2C, lvar_20, sub_004B9E10, lvar_60);
                end;//8
                if (f54 = lvar_28) then
                begin//8
                  //0051E421
            ...
            begin//6
              ...
              begin//7
                ...
                begin//8
                  ...
                  begin//9
                    //0051E50A
                    f3C.sub_004C64CC(lvar_70[lvar_28 - 1], lvar_20,lvar_200);
                    f3C.sub_004C2410(lvar_200, sub_004BC298, lvar_60);
                  end;//9
                  lvar_E4 := f3C.sub_004BE9E0() + lvar_58;
                  if (lvar_28 <= 255) then
                  begin//9
                    ...
                    begin//10
                      //0051E5E5
                      f3C.sub_004C2D10(lvar_28 - lvar_58, lvar_20, sub_004B9E10, lvar_60);
                    end;//10
                    if (sub_004BC188) then
                    begin//10
                      //0051E63E
                      ...
                      begin//11
                        //0051E650
                        //push EAX
                        f3C.sub_004C9594(lvar_20, sub_004BC298, lvar_60);
                      end;//11
                      if (lvar_C - 4 = lvar_28) then
                      begin//11
                        //0051E699
                        f3C.sub_004C9708(lvar_20, sub_004BC298, lvar_60);
                      end;//11
                    end;//10
                  end;//9
                end;//8
              ...
              begin//7
                ...
                begin//8
                  ...
                  begin//9
                    //0051E708
                    f3C.sub_004C2D10(lvar_28, lvar_20, sub_004B9E10, lvar_60);
                  end;//9
                end;//8
              end;//7
              if (sub_004BC1BC) then
              begin//7
                ...
                begin//8
                  //0051E76C
                  f3C.sub_004C32B4(lvar_20,sub_004B9E10, sub_004BC298, sub_004BC30C, lvar_60);
                end;//8
                if (f54 = lvar_28) then
                begin//8
                  //0051E7BA
            ...
            begin//6
              ...
              begin//7
                //0051E91D
                if (sub_004BBFB8) then
                begin//8
                  //0051E92A
                  try
                    //0051E938
                    E := sub_004B9E48;//moyennesSur
                    if (Strtofloat(lvar_60) >  sub_004B9E48/ 2) then
                    begin//10
                      //0051E960
    ...
    begin//2
      //0051EC6E
        ...
        begin//4
		  ...
		  begin
			R.Left :=lvar_34;//lvar_34
			R.Top := lvar_18 * (f3C.sub_004BEA58 + lvar_4C + 1) + lvar_38 + 20;//EAX
			R.Right := R.Left + lvar_24;//EAX
			R.Bottom := R.Top + lvar_18;//EAX
						...
						begin//8
							...
							begin//9
								...
								begin//10
									...
									//lvar_88 := f3C;
									//EBX := f3C.sub_004BEA58;
									if (f3C.sub_004BEA58 > 0) then
									begin//11
										//0051EF19
										for lvar_20 := 1 to f3C.sub_004BEA58 do
										begin//12
											//0051EF20
											f3C.sub_004C2E60(lvar_70[lvar_28 - 1], f2C,lvar_20,lvar_200 );
									...
									begin//12
										//0051EFE0
										sub_004BDB3C(lvar_78, lvar_60);
									end;//12
									1:
									begin//12
									  //0051F001
									  sub_004BDCFC(lvar_78, lvar_60);
									end;//12
									2:
									begin//12
									  //0051F01F
									  sub_004BDEBC(lvar_78, lvar_60);
									end;//12
									3:
									begin//12
									  //0051F03D
									  sub_004BDFE8(lvar_78, lvar_60);
									end;//12
									4:
									begin//12
									  //0051F05B
									  sub_004BE1C4(lvar_78, lvar_60);
									end;//12
									5:
									begin//12
									  //0051F079
									  sub_004BE364(lvar_78, lvar_60);
									end;//12
								end;//11
									lvar_78.Destroy;
								end;//10
						...
						begin//8
						  ...
						  begin//9
							...
							begin//10
							  ...
							  begin//11
								//0051F117
								f3C.sub_004C8F6C(f2C, lvar_20, sub_004B9E10, lvar_200);
								lvar_78.Add(lvar_200);
							  end;//11
							end;//10
							case lvar_1C of
						  ...
						  begin//9
							...
							begin//10
							  ...
							  begin//11
								//0051F2A9
								f3C.sub_004C9280(f2C, lvar_20, sub_004B9E10, lvar_200);
								lvar_78.Add(lvar_200);
							  end;//11
							end;//10
							case lvar_1C of
						...
						begin//8
						  ...
						  begin//9
							...
							begin//10
							  ...
							  begin//11
								//0051F44E
								f3C.sub_004C2D10(f2C, lvar_20, sub_004B9E10, lvar_200);
								lvar_78.Add(lvar_200);
							  end;//11
							end;//10
							case lvar_1C of
                  ...
                  begin//9
                    ...
                    begin//10
                      ...
                      begin//11
                        //0051F7CD
                        f3C.sub_004C64CC(lvar_70[lvar_28 - 1], lvar_20,lvar_200);
                        f3C.sub_004C2410(lvar_200, sub_004BC298, lvar_200);
                        lvar_78.Add(lvar_200);
                      end;//11
                    end;//10
                    case lvar_1C of
                  ...
                  begin//9
                    ...
                    begin//10
                      ...
                      begin//11
                        ...
                        begin//12
                          //0051F9F0
                          f3C.sub_004C2D10(lvar_28 - K, lvar_20, sub_004B9E10, lvar_200);
                          lvar_78.Add(lvar_200);
                        end;//12
                      end;//11
                      case lvar_1C of
                    ...
                    begin//10
                      ...
                      begin//11
                        ...
                        begin//12
                          ...
                          begin//13
                            //0051FBB8
                            f3C.sub_004C9594(lvar_20, sub_004BC298, lvar_200);
                            lvar_78.Add(lvar_200);
                          end;//13
                        end;//12
                        case lvar_1C of
                      ...
                      begin//11
                        ...
                        begin//12
                          ...
                          begin//13
                            //0051FD38
                            f3C.sub_004C9708(lvar_20, sub_004BC298, lvar_200);
                            lvar_78.Add(lvar_200);
                          end;//13
                        end;//12
                        case lvar_1C of
                    ...
                    begin//10
                      ...
                      begin//11
                        ...
                        begin//12
                          ...
                          begin//13
                            //0051FECB
                            f3C.sub_004C32B4( lvar_20, sub_004B9E10, sub_004BC298, sub_004BC30C, lvar_200);
                            lvar_78.Add(lvar_200);
                          end;//13
                        end;//12
                        case lvar_1C of
	...
	// Fin Boucle !
      ...
      //0052034A
        ...
        begin//4
          //00520360
          f40.MoveTo(lvar_34, (f3C.sub_004BEA58 + 1 + lvar_1C) * lvar_18 + lvar_38 + 20);
          f40.LineTo(lvar_34 + lvar_2C, (f3C.sub_004BEA58 + 1 + lvar_1C) * lvar_18 + lvar_38 + 20);
        end;//4
...
begin//0
  //00520890
  result := sub_0051D370 * (f50[a] - f50[a - 1]) + sub_00519AF8(sub_004BD1FC, sub_004BDA2C);
end;//0
