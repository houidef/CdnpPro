...
Forms, Windows,  SysUtils, Classes , Registry;
    ...
    function sub_00497268(x:String; y:dword;Z:boolean):byte;//00497268
    ...
    function sub_004975A8(a:AnsiString; b:dword;c:boolean):dword;//004975A8
...
//00497268
function sub_00497268(x:String; y:dword;Z:boolean):byte;
var
	Registry :TRegistry;
begin//0
    Registry := TRegistry.Create;
...
//004975A8
function sub_004975A8(a:String; b:dword;c:boolean):dword;
var
  Registry:TRegistry;
begin//0
    Registry := TRegistry.Create;
